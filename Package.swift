...
let package = Package(
    ...
    products: [
        ...
        .executable(name: "loci-type-convert-demo", targets: ["loci-type-convert-demo"]),
        ...
        .executable(name: "loci-object-select-demo", targets: ["loci-object-select-demo"]),
        .executable(name: "loci-dashboard-demo", targets: ["loci-dashboard-demo"]),
        .executable(name: "loci-kanban-demo", targets: ["loci-kanban-demo"]),
        .executable(name: "loci-weblink-preview-demo", targets: ["loci-weblink-preview-demo"]),
        .executable(name: "loci-unlinked-mentions-demo", targets: ["loci-unlinked-mentions-demo"]),
    ],
    dependencies: [
    ...
    targets: [
        ...
        .executableTarget(
            name: "loci-type-convert-demo",
            dependencies: ["LociVault", "LociIndex", "LociMarkdown", "LociCore"],
            path: "LociVault/Sources/LociTypeConvertDemo"
        ),
        .executableTarget(
            name: "loci-ai-demo",
            dependencies: ["LociVault", "LociIndex", "LociMarkdown", "LociCore"],
            path: "LociVault/Sources/LociAIDemo"
        ),
        .executableTarget(
            name: "loci-apple-demo",
            dependencies: ["LociVault", "LociIndex", "LociMarkdown", "LociCore"],
            path: "LociVault/Sources/LociAppleDemo"
        ),
        .executableTarget(
        ...
        .executableTarget(
            name: "loci-object-select-demo",
            dependencies: ["LociVault", "LociIndex", "LociMarkdown", "LociCore"],
            path: "LociVault/Sources/LociObjectSelectDemo"
        ),
        .executableTarget(
            name: "loci-dashboard-demo",
            dependencies: ["LociVault", "LociIndex", "LociMarkdown", "LociCore"],
            path: "LociVault/Sources/LociDashboardDemo"
        ),
        .executableTarget(
            name: "loci-kanban-demo",
            dependencies: ["LociVault", "LociIndex", "LociMarkdown", "LociCore"],
            path: "LociVault/Sources/LociKanbanDemo"
        ),
        .executableTarget(
            name: "loci-weblink-preview-demo",
            dependencies: ["LociVault", "LociIndex", "LociMarkdown", "LociCore"],
            path: "LociVault/Sources/LociWeblinkPreviewDemo"
        ),
        .executableTarget(
            name: "loci-unlinked-mentions-demo",
            dependencies: ["LociVault", "LociIndex", "LociMarkdown", "LociCore"],
            path: "LociVault/Sources/LociUnlinkedMentionsDemo"
        ),
        .testTarget(
            name: "LociVaultTests",
            dependencies: ["LociVault", "LociIndex", "LociMarkdown", "LociCore"],
