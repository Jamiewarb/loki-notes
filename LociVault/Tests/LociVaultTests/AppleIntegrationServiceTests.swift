    ...
    func testIndexAndSettingsNotInVault() async throws {
        ...
        XCTAssertTrue(
            LociVaultModule.version.contains("pr31") || LociVaultModule.version.contains("pr32")
                ...
                || LociVaultModule.version.contains("pr36") || LociVaultModule.version.contains("pr37") || LociVaultModule.version.contains("pr38") || LociVaultModule.version.contains("pr39") || LociVaultModule.version.contains("pr40") || LociVaultModule.version.contains("pr41") || LociVaultModule.version.contains("pr42")
        )
    }
