    ...
    func testModuleVersionIsPR13() {
        XCTAssertTrue(
            LociVaultModule.version.contains("pr13")
                ...
                || LociVaultModule.version.contains("pr18") || LociVaultModule.version.contains("pr19") || LociVaultModule.version.contains("pr20") || LociVaultModule.version.contains("pr21")
        )
    }
}
