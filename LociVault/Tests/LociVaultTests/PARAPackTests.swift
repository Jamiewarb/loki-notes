...
final class PARAPackTests: XCTestCase {
    ...
    func testModuleVersionPR15() {
        XCTAssertTrue(LociVaultModule.version.contains("pr15") || LociVaultModule.version.contains("pr16") || LociVaultModule.version.contains("pr17") || LociVaultModule.version.contains("pr18") || LociVaultModule.version.contains("pr19"))
        XCTAssertTrue(LociIndexModule.version.contains("pr15") || LociIndexModule.version.contains("pr17") || LociIndexModule.version.contains("pr18") || LociIndexModule.version.contains("pr19"))
    }
}
