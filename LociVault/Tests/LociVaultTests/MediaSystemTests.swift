...
final class MediaSystemTests: XCTestCase {
    ...
    func testModuleVersionIsPR38() {
        XCTAssertTrue(LociVaultModule.version.contains("pr38"), LociVaultModule.version)
        XCTAssertEqual(LociVaultModule.version, "0.38.0-pr38")
    }
}
