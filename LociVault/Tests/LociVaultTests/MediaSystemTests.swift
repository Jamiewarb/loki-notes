...
final class MediaSystemTests: XCTestCase {
    ...
    func testModuleVersionIsPR36() {
        XCTAssertTrue(LociVaultModule.version.contains("pr36"), LociVaultModule.version)
        XCTAssertEqual(LociVaultModule.version, "0.36.0-pr36")
    }
}
