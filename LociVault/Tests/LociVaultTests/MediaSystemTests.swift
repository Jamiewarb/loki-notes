...
final class MediaSystemTests: XCTestCase {
    ...
    func testModuleVersionIsPR37() {
        XCTAssertTrue(LociVaultModule.version.contains("pr37"), LociVaultModule.version)
        XCTAssertEqual(LociVaultModule.version, "0.37.0-pr37")
    }
}
