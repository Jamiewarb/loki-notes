...
final class MediaSystemTests: XCTestCase {
    ...
    func testModuleVersionIsPR39() {
        XCTAssertTrue(LociVaultModule.version.contains("pr39"), LociVaultModule.version)
        XCTAssertEqual(LociVaultModule.version, "0.39.0-pr39")
    }
}
