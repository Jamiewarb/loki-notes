...
final class PinsSystemTests: XCTestCase {
    ...
    func testModuleVersionIsPR34() {
        XCTAssertTrue(
            LociVaultModule.version.contains("pr34") || LociVaultModule.version.contains("pr35") || LociVaultModule.version.contains("pr36") || LociVaultModule.version.contains("pr37"),
