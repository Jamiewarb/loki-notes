...
final class KanbanSystemTests: XCTestCase {
    ...
    func testModuleVersionIsPR42() {
        XCTAssertTrue(LociVaultModule.version.contains("pr42") || LociVaultModule.version.contains("pr43") || LociVaultModule.version.contains("pr44") || LociVaultModule.version.contains("pr45"), LociVaultModule.version)
        XCTAssertTrue(
