...
final class PropertiesSystemTests: XCTestCase {
    ...
    func testModuleVersionIsPR13() {
        XCTAssertTrue(LociVaultModule.version.contains("pr13") || LociVaultModule.version.contains("pr14") || LociVaultModule.version.contains("pr15") || LociVaultModule.version.contains("pr16") || LociVaultModule.version.contains("pr17") || LociVaultModule.version.contains("pr18"))
        XCTAssertTrue(LociIndexModule.version.contains("pr13") || LociIndexModule.version.contains("pr14") || LociIndexModule.version.contains("pr15") || LociIndexModule.version.contains("pr17") || LociIndexModule.version.contains("pr18"))
    }
}
