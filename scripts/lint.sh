...
if [[ -d "$ROOT/App/Features/Pins" ]]; then
  pass "App/Features/Pins present"
else
...
if [[ -d "$ROOT/App/Features/Links" ]]; then
  pass "App/Features/Links present"
else
  fail "App/Features/Links missing"
fi
